Github有众多优秀的Agent、大模型相关项目可以学习，等学会理解后完全可以借鉴吸收成为简历的一部分。
不建议大家直接去学习那些概念，学习一个具体的项目更有深刻的体会。
    我将我学过的项目贴到下面：
1.HKUDS/nanobot: "🐈 nanobot: The Ultra-Lightweight OpenClaw" (github.com)
...
3.jd-opensource/joyagent-jdgenie: 开源的端到端产品级通用智能体 (github.com)
4.训练一个小参数LLM: jingyaogong/minimind: 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h! (github.com)
5.RAG: jamwithai/production-agentic-rag-course (github.com)
6.shareAI-lab/learn-claude-code: Bash is all you need - A nano claude code–like 「agent harness」, built from 0 to 1 (github.com)
7. datawhale的很多课程都适合小白入手，等你学习完一个就可以初步入门这个方向。课程很多在这就不完全列举了：
